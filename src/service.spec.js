...
describe('server.js: exported methods', () => {
    beforeEach(async () => {
        ...
        nock(`https://firebasestorage.googleapis.com`)
            .get(
                `/v0/b/eco-bot-data.appspot.com/o/${process.env.CITY_CODE}-dev.json?alt=media`
            )
    ...
    describe('server.js - getCalendar', () => {
        ...
        it('should return the correct calendar', () => {
            ...
            spyOn(Date, 'now').and.returnValue(
                new Date('2020-03-25T16:00:00.000Z')
            )
    ...
    describe('server.js - getTomorrowSchedule', () => {
        ...
        it('should return correct schedule for tomorrow', () => {
            ...
            expect(service.getTomorrowSchedule()).toEqual(
                cityDataMock.Calendar['2020']['03']['26']
            )
        })
    })
    ...
    describe('server.js - getCollectionInfo', () => {
        ...
        it('should parse the collection data info properly', () => {
            ...
            expect(collectionInfo.allowTakeOutTrashFromHour).toEqual(
                cityDataMock.CollectionInfo.allowTakeOutTrashFromHour
            )
            expect(collectionInfo.collectionStartHourOfTheDay).toEqual(
                cityDataMock.CollectionInfo.collectionStartHourOfTheDay
            )
        })
    })
})
